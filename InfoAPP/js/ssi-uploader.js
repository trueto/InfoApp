...
//----------------------------UPLOADFILES------------------------------------
    ...
    var locale = {
        zh:{
          ...
          clear: '清空',
          drag: '拖拽多个文件上传',
          sizeError: '$1 文件大小超过 $2',// $1=file name ,$2=max ie( example.jpg has has exceed the size limit of 2mb)
          extError: '$1 文件类型不被支持',//$1=file extension ie(exe files are not supported)
